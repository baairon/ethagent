...
test('browser wallet page explains the wallet approval', () => {
  ...
  assert.match(page, /CLOSE_DELAY_MS = 10000/)
  assert.match(page, /TX_CLOSE_DELAY_MS = 10000/)
  assert.match(page, /CANCEL_CLOSE_DELAY_MS = 3200/)
  assert.match(page, /return to your terminal\. closing in " \+ seconds \+ "s\./)
